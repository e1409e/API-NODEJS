 ...
 */
router.get('/:id_facultad', facultadesValidations.eliminarFacultadValidations, validar, obtenerFacultadPorId);
 ...
 */
router.post('/', facultadesValidations.crearFacultadValidations, validar, crearFacultad);
 ...
 */
router.put('/:id_facultad', facultadesValidations.editarFacultadValidations, validar, editarFacultad);
 ...
 */
router.delete('/:id_facultad', facultadesValidations.eliminarFacultadValidations, validar, eliminarFacultad);
