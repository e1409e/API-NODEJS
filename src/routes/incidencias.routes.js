 ...
 */
router.get('/estudiante/:id_estudiante', obtenerIncidenciasPorEstudiante); // No se aplica validación de ID de estudiante en la ruta, se asume que el controlador lo maneja o que la ruta que lleva a este endpoint lo valida.
